...
export class AppComponent {
  ...
  alumnoArray: Alumno[] = [
    { id: 1, name: "Alex", lastname: "Campos", age: 35, direccion: "San martin, san salvador", telefono: "7785-1123", correo: "alex@gmail.com" },
    { id: 2, name: "Maria", lastname: "Lopez", age: 20, direccion: "Soyapango, san salvador", telefono: "7733-9123", correo: "maria@gmail.com" },
    { id: 3, name: "Juan", lastname: "Castro", age: 25, direccion: "ilopango, san salvador", telefono: "7695-1443", correo: "juanl@gmail.com" }
  ]
